...
namespace LocalGPT.Services
{
    public sealed class SqliteUtilityService
    {
        ...
        //            Scope = "Blazor frontend",
        //            Source = seedSource,
        //            Content = "TacosPortalOpen is a useful local architecture sample for this project's Blazor work. Relevant server-side patterns include Routes.razor " +
        ...
        //            Source = seedSource,
        //            Content = "For a configured high-end local workstation, prefer one active Ollama model at a time for council phases and order lightweight/known-stable models first. " +
        ...
        //            Source = seedSource,
        //            Content = "If the current user says LocalGPT, DXAiChat, the AI Council, or a model lacks a capability, refuses too quickly, misses source knowledge, or generates the wrong artifact shape, treat that as approved product feedback and investigate. " +
