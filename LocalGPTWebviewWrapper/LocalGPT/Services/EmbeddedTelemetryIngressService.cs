    ...
    ILogger<EmbeddedTelemetryIngressService> logger) : IEmbeddedTelemetryIngressService
{
    ...
    private EmbeddedTelemetryReading CloneReading(EmbeddedTelemetryReading source) => new()
    {
    ...
    private EmbeddedTelemetrySnapshot CloneSnapshot(EmbeddedTelemetrySnapshot source) => new()
    {
