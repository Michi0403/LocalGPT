...
""", "System.String"),
                ...
                [
                    ...
                    new(LocalGptRuntimeCollection.BinaryExtensions, nameof(LocalGptRuntimeCollection.BinaryExtensions), [".dll", ".exe", ".pdb", ".msi", ".pfx", ".png", ".jpg", ".jpeg", ".gif", ".ico", ".pdf", ".db", ".sqlite", ".sqlite3", ".zip", ".nupkg"]),
                    new(LocalGptRuntimeCollection.SourceExtensions, nameof(LocalGptRuntimeCollection.SourceExtensions), [".cs", ".csproj", ".sln", ".razor", ".xaml", ".json", ".xml", ".py", ".js", ".ts", ".html", ".css", ".sql", ".md", ".yml", ".yaml", ".ps1", ".props", ".targets", ".config", ".resx", ".mdx", ".go", ".mod", ".sum", ".proto", ".toml", ".ini", ".cmake", ".sh", ".bat", ".cmd", ".gotmpl", ".txt", ".text", ".log", ".csv", ".tsv", ".http", ".rest", ".tmpl"]),
                    new(LocalGptRuntimeCollection.ArtifactTextExtensions, nameof(LocalGptRuntimeCollection.ArtifactTextExtensions), [".cs", ".razor", ".cshtml", ".csproj", ".sln", ".props", ".targets", ".md", ".txt", ".json", ".xml", ".css", ".scss", ".js", ".ts", ".yml", ".yaml", ".ps1", ".sql", ".html", ".htm", ".mcfunction", ".mcmeta", ".toml", ".properties", ".java"]),
                    new(LocalGptRuntimeCollection.KnowledgeFiles, nameof(LocalGptRuntimeCollection.KnowledgeFiles), ["AGENTS.md", "docs/ARCHITECTURE_FOR_AI.md", "docs/COUNCIL_KNOWLEDGE_SEED.sql", "docs/MINECRAFT_MOD_AI_BUILDER.md", "docs/MINECRAFT_SOURCE_KNOWLEDGE.md", "docs/AI_HOST_DOTNET_EXPERIMENT.md", "docs/AI_HOST_DOTNET_BLAZOR_REBUILD_GUIDE.md", "docs/AI_HOST_CONTROL_PLANE_ARCHITECTURE.md", "docs/DOTNET_AI_HOST_ARCHITECTURE_PATTERNS.md", "docs/LOCALGPT_DEVELOPER_DIARY.md", "docs/LOCALGPT_WORKFLOW_MEMORY.md", "docs/CAPABILITY_GAP_CONTRACT.md", "docs/BLAZOR_DEVEXPRESS_AI_GENERATION.md", "docs/BLAZOR_BOOTSTRAP_DEVEXPRESS_DESIGN.md", "docs/FRONTEND_DESIGN_PATTERN_LIBRARY.md", "docs/MICROSOFT_DOTNET_SAMPLE_CURRICULUM.md", "docs/EF_DEVEXPRESS_BUSINESS_OBJECTS.md", "docs/GENERATION_ARCHETYPE_CONTRACTS.md"]),
                    ...
                    new(LocalGptRuntimeCollection.ArchitectureUiStackOptions, nameof(LocalGptRuntimeCollection.ArchitectureUiStackOptions), ["Ask me before choosing UI stack", "DevExpress Blazor components", "Plain Blazor components", "No UI / backend or tool only", "Other target-specific UI"]),
                    new(LocalGptRuntimeCollection.ArchitectureSolutionShapeOptions, nameof(LocalGptRuntimeCollection.ArchitectureSolutionShapeOptions), ["Ask me before choosing solution shape", "Single cohesive solution", "Split backend and frontend projects", "Library/plugin/package only", "Datapack/mod workspace only"]),
                    new(LocalGptRuntimeCollection.ArchitectureRenderModeOptions, nameof(LocalGptRuntimeCollection.ArchitectureRenderModeOptions), ["Ask me before choosing runtime/rendering", "Blazor Server / InteractiveServer", "Blazor WebAssembly with ASP.NET Core backend", "Static SSR plus interactive islands", "ASP.NET Core API / backend only", "Desktop wrapper / WebView2", "Minecraft Java/datapack runtime", "CLI/tooling runtime"]),
