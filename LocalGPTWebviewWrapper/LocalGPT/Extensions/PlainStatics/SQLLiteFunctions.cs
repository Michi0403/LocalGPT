...
namespace LocalGPT.Extensions.PlainStatics
{
    public static class SQLLiteFunctions
    {
        ...
        public static string BuildTags(MultiModelCouncilResult result, bool nonSubstantive, ILogger logger)
        {
            try
            {
        ...
        public static bool LooksLikeNonSubstantiveContent(string content, ILogger logger)
        {
            try
            {
        ...
        public static string ExtractHelpfulSources(string text, ILogger logger)
        {
            try
            {
