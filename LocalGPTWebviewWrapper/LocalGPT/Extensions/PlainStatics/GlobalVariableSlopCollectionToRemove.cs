...
namespace LocalGPT.Extensions.PlainStatics
{
    public static partial class GlobalVariableSlopCollectionToRemove
    {
        ...
        public sealed class VisibleThinkingStreamFormatter(bool harmonyModel)
        {
            ...
            public IEnumerable<string> AppendTaggedContent(string text)
            {
                if (string.IsNullOrEmpty(text))
                    yield break;
            ...
            public IEnumerable<string> CompleteTaggedContent()
            {
            ...
            public IEnumerable<string> CompleteHarmonyContent()
            {
            ...
            public IEnumerable<string> EmitHarmonyDeltas(string raw)
            {
