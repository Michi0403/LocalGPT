...
namespace LocalGPT.Extensions.PlainStatics
{
    ...
    public  static partial class CouncilChatStringFunctions
    {
        ...
        public static string NormalizeModId(string value, string fallback)
        {
        ...
        public static string CreateFabricSettingsGradle(string projectName) =>
            $$"""
            pluginManagement {
                repositories {
            ...
            """;
        public static string CreateNeoForgeSettingsGradle(string projectName) =>
    $$"""
            pluginManagement {
                repositories {
            ...
            rootProject.name = '{{projectName}}'
            """;
        public static string CreateFabricBuildGradle(MinecraftModBuildRequest request, WorkspaceContext context) =>
       $$"""
            plugins {
            ...
            """;
        public static string CreateNeoForgeBuildGradle(MinecraftModBuildRequest request, WorkspaceContext context) =>
    $$"""
            plugins {
                id 'java-library'
                id 'maven-publish'
            ...
            """;
        public static string CreatePaperSettingsGradle(string projectName) =>
    $$"""
            pluginManagement {
                repositories {
                    gradlePluginPortal()
            ...
            rootProject.name = '{{projectName}}'
            """;
        public static string CreatePaperBuildGradle(MinecraftModBuildRequest request, WorkspaceContext context) =>
    $$"""
            plugins {
                id 'java'
            }
        ...
        public static string CreateFabricMainClass(WorkspaceContext context) =>
            $$"""
        ...
        public static string CreateNeoForgeMainClass(WorkspaceContext context) =>
            $$"""
            package {{context.PackageName}};
        ...
        public static string CreatePaperMainClass(WorkspaceContext context) =>
            $$"""
            package {{context.PackageName}};
        ...
        public static string CreateFabricEmptyMainClass(WorkspaceContext context) =>
            $$"""
            package {{context.PackageName}};
        ...
        public static string CreateNeoForgeEmptyMainClass(WorkspaceContext context) =>
            $$"""
            package {{context.PackageName}};
        ...
        public static string CreateLivingCitiesReportClass(string packageName) =>
            $$"""
            package {{packageName}};
            ...
            """;
        public static string CreateFabricMetadata(MinecraftModBuildRequest request, WorkspaceContext context) =>
    $$"""
            {
              "schemaVersion": 1,
              "id": "{{context.ModId}}",
        ...
        public static string CreateNeoForgeMetadata(MinecraftModBuildRequest request, WorkspaceContext context) =>
            $$"""
            modLoader="javafml"
        ...
        public static string CreatePaperPluginYaml(MinecraftModBuildRequest request, WorkspaceContext context) =>
            $$"""
            name: ${plugin_name}
            version: ${plugin_version}
            main: ${plugin_main}
            ...
            permissions:
              {{context.ModId}}.report:
                ...
                default: true
            """;
        public static string CreateEnglishLang(string modId) =>
     $$"""
            {
        ...
        public static string CreateCityCharterModel() =>
            """
            {
        ...
        public static string CreateDatapackLoadFunction(WorkspaceContext context) =>
            $$$"""
        ...
        public static string CreateDatapackTickFunction(WorkspaceContext context) =>
            $$$"""
        ...
        public static string CreateDatapackScheduleFunction(WorkspaceContext context) =>
            $$$"""
        ...
        public static string CreateDatapackCityCreateFunction(WorkspaceContext context) =>
            $$$"""
        ...
        public static string CreateDatapackCityCreateNewFunction(WorkspaceContext context) =>
            $$$"""
        ...
        public static string CreateDatapackCityAlreadyExistsFunction() =>
            """
        ...
        public static string CreateDatapackRegisterBannerFunction(WorkspaceContext context) =>
            $$$"""
        ...
        public static string CreateDatapackUpdatePopulationFunction(WorkspaceContext context) =>
            $$$"""
            scoreboard players set #population lc_population 0
        ...
        public static string CreateDatapackCitizenRegisterFunction(WorkspaceContext context) =>
            $$$"""
            execute unless data storage {{{context.ModId}}}:city {founded:1b} run return 0
            scoreboard players set #registered_this_scan lc_population 0
        ...
        public static string CreateDatapackCitizenDetectNewFunction() =>
            """
        ...
        public static string CreateDatapackCitizenAgingFunction() =>
            """
        ...
        public static string CreateDatapackCitizenPersonalitiesFunction(WorkspaceContext context) =>
            $$$"""
        ...
        public static string CreateDatapackCitizenStatusFunction(WorkspaceContext context) =>
            $$$"""
        ...
        public static string CreateDatapackFoodUpdateFunction(WorkspaceContext context) =>
            $$$"""
        ...
        public static string CreateDatapackFoodProductionFunction() =>
            """
        ...
        public static string CreateDatapackFoodConsumptionFunction() =>
            """
            scoreboard players operation #food_consumption lc_tmp = #population lc_population
            """;

        public static string CreateDatapackSecurityUpdateFunction(WorkspaceContext context) =>
            $$$"""
        ...
        public static string CreateDatapackSecurityGolemsFunction() =>
            """
        ...
        public static string CreateDatapackSecurityNightwatchFunction() =>
            """
        ...
        public static string CreateDatapackChronicleAddEventFunction(WorkspaceContext context) =>
            $$$"""
            data modify storage {{{context.ModId}}}:chronicle events append value {type:"city_founded",text:"A city was founded.",year:1}
            """;

        public static string CreateDatapackChronicleUpdateFunction(WorkspaceContext context) =>
            $$$"""
        ...
        public static string CreateDatapackAdminBookFunction(WorkspaceContext context)
        {
        ...
        public static string CreateDatapackTownHallFunction(WorkspaceContext context) =>
            $$$"""
        ...
        public static string CreateDatapackReportFunction(WorkspaceContext context) =>
            $$$"""
        ...
        public static string CreateDatapackChronicleUiFunction(WorkspaceContext context) =>
            $$$"""
        ...
        public static string CreateDatapackQuestGenerateFunction(WorkspaceContext context) =>
            $$$"""
        ...
        public static string CreateDatapackBuildingsInitFunction() =>
            """
            scoreboard players set #houses lc_buildings 0
            scoreboard players set #workplaces lc_buildings 0
            """;

        public static string CreateDatapackRegisterHouseFunction(WorkspaceContext context) =>
            $$$"""
        ...
        public static string CreateDatapackBuildingDebugListFunction(WorkspaceContext context) =>
            $$$"""
        ...
        public static string CreateDatapackResetCityFunction(WorkspaceContext context) =>
            $$$"""
        ...
        public static string CreateDatapackBuildScript(WorkspaceContext context) =>
            $$"""
            [CmdletBinding()]
            param(
        ...
        public static string CreateDatapackBenchmarkNotes(WorkspaceContext context) =>
            $$"""
        ...
        public static string CreateDatapackReadme(MinecraftModBuildRequest request, WorkspaceContext context) =>
            $$"""
        ...
        public static string CreateWorkspaceReadme(MinecraftModBuildRequest request, WorkspaceContext context, string loader) =>
            $$"""
            # {{context.ProjectName}}
        ...
        public static string CreateLivingCitiesPlan(MinecraftModBuildRequest request) =>
            $$"""
    ...
    fileName.Equals("package.json", StringComparison.OrdinalIgnoreCase);
        ...
        public static string MultiModelCouncilServiceBuildArtifactsMarkdown(IEnumerable<CouncilArtifact> artifacts, ILogger logger)
        {
            try
            {
                var builder = new StringBuilder()
        ...
        public static string MultiModelCouncilServiceBuildTranscript(IEnumerable<MultiModelCouncilStep> steps, ILogger logger)
        {
            try
            {
                var builder = new StringBuilder();
        ...
        public static string MultiModelCouncilServiceCreateCouncilSystemPrompt(string modelName, IReadOnlyList<string> councilMembers, ILogger logger)
        {
            try
            {
                return $"""
            ...
            {
                logger.LogError(ex, $"Error in CreateCouncilSystemPrompt modelName {modelName?.ToString()} councilMembers {councilMembers?.ToString()}");
                return string.Empty;
            }
        }

        public static string MultiModelCouncilServiceCreateProposalPrompt(string modelName, string userPrompt, ILogger logger)
        {
            try
            {
                return $"""
            ...
            {
                logger.LogError(ex, $"Error in CreateProposalPrompt modelName {modelName?.ToString()} userPrompt {userPrompt?.ToString()}");
                return string.Empty;
            }
        }

        public static string MultiModelCouncilServiceCreateCritiquePrompt(string modelName, string userPrompt, string transcript, bool selfReview, ILogger logger)
        {
            try
            {
                return $"""
            ...
            {
                logger.LogError(ex, $"Error in CreateCritiquePrompt modelName {modelName?.ToString()} userPrompt {userPrompt?.ToString()} transcript {transcript?.ToString()} selfReview {selfReview.ToString()}");
                return string.Empty;
            }
        }

        public static string MultiModelCouncilServiceCreateConsensusPrompt(string userPrompt, string transcript, ILogger logger)
        {
            try
            {
                return $"""
            ...
            {
                logger.LogError(ex, $"Error in CreateConsensusPrompt userPrompt {userPrompt?.ToString()} transcript {transcript?.ToString()}");
                return string.Empty;
            }
        }

        public static string MultiModelCouncilServiceCreateVerificationPrompt(string userPrompt, string transcript, string consensus, ILogger logger)
        {
            try
            {
                return $"""
            ...
            {
                logger.LogError(ex, $"Error in CreateVerificationPrompt userPrompt {userPrompt?.ToString()} transcript {transcript?.ToString()} consensus {consensus?.ToString()}");
                return string.Empty;
            }
        }

        public static string MultiModelCouncilServiceExtractThinking(string content, ILogger logger)
        {
            try
            {
                var match = GlobalVariableSlopCollectionToRemove.ThinkingBlockPattern().Match(content);
        ...
        public static string MultiModelCouncilServiceStripThinking(string content, ILogger logger)
        {
            try
            {
                var stripped = GlobalVariableSlopCollectionToRemove.ThinkingBlockPattern().Replace(content, string.Empty);
                stripped = GlobalVariableSlopCollectionToRemove.StreamStatusPattern().Replace(stripped, string.Empty);
        ...
        public static string MultiModelCouncilServiceTrimCouncilText(string content, int maxLength, ILogger logger)
        {
            try
            {
            ...
            {
                logger.LogError(ex, $"Error in StripThinking content {content?.ToString()} maxLength {maxLength.ToString()}");
                return string.Empty;
            }

        }

        public static string MultiModelCouncilServiceNormalizeEndpoint(string endpoint, ILogger logger)
        {
            try
            {
                return string.IsNullOrWhiteSpace(endpoint)
                ? GlobalVariableSlopCollectionToRemove.DefaultOllamaUri
        ...
        public static IEnumerable<string> AppendHarmonyContent(string text, ILogger logger)
        {
            try
            {
                ...
                {
                    harmonyBuffer.Clear();
                    foreach (var chunk in CouncilChatStringFunctions.AppendTaggedContent(raw,true,logger))
                        yield return chunk;
                    yield break;
                }

                foreach (var chunk in CouncilChatStringFunctions.EmitHarmonyDeltas(raw,true,logger))
                    yield return chunk;
            }
            finally 
            {
                logger.LogInformation($"Appended Harmony Content {text}");
            }

        }
        public static string BuildSourcePreviewMarkup(string relativePath, string source, ILogger logger)
        {
            try
            {
            ...
            {
                logger.LogError(ex,$"Error in BuildSourcePreviewMarkup relativePath {relativePath} source {source}");
                return string.Empty;
            }
         
        }
        public static bool IsAllowedLocalRoute(string route, ILogger logger)
        {
            try
            {
        ...
        public static string PrettyPrintJson(string text, ILogger logger)
        {
            try
            {
                if (string.IsNullOrWhiteSpace(text))
    ...
    bool useLocalGptOmission = false)
        {
            try
            {
                ...
                if (maxCharacters <= GlobalVariableSlopCollectionToRemove. omission.Length + 40)
                {
                ...
                if (!keepBothEnds)
                {
                    var available = maxCharacters - GlobalVariableSlopCollectionToRemove.shortOmission.Length;

                    if (available <= 0)
                        return normalized[..Math.Min(normalized.Length, maxCharacters)].Trim();

                    return $"{normalized[..available].TrimEnd()}{GlobalVariableSlopCollectionToRemove.shortOmission}";
                }

                var remaining = maxCharacters - GlobalVariableSlopCollectionToRemove.omission.Length;
                ...
                return $"{normalized[..head].TrimEnd()}{GlobalVariableSlopCollectionToRemove.omission}{normalized[^tail..].TrimStart()}";
            }
            catch (Exception ex)
            {
                logger.LogError(ex, $"Error in TrimForPrompt text {text} maxCharacters {maxCharacters} keepBothEnds {keepBothEnds} collapseWhitespace {collapseWhitespace} useLocalGptOmission {useLocalGptOmission}");
                return string.Empty;
            }
        }
        ...
        public static IEnumerable<string> AppendThinking(string text, bool harmonyModel, ILogger logger)
        {
            try
            {
                ...
                foreach (var chunk in CouncilChatStringFunctions.OpenThinkingBlock(logger))
                    yield return chunk;
            ...
            finally
            {
                ...
                logger.LogInformation($"ended AppendThinking text:{text} harmonyModel:{harmonyModel}");
        ...
        public static IEnumerable<string> AppendContent(string text, bool harmonyModel, ILogger logger)
        {
            try
            {
                ...
                if (harmonyModel)
                {
                    foreach (var chunk in AppendHarmonyContent(text, logger))
                        yield return chunk;
                    yield break;
                }

                foreach (var chunk in AppendTaggedContent(text, harmonyModel, logger))
                    yield return chunk;
            }
            finally
            {

                logger.LogInformation($"ended AppendContent text:{text} harmonyModel:{harmonyModel}");
        ...
        public static IEnumerable<string> AppendTaggedContent(string text, bool harmonyModel, ILogger logger)
        {
                ...
                while (contentBuffer.Length > 0)
                {
                    ...
                    if (inTaggedThinking)
                    {
                        ...
                        if (endIndex >= 0)
                        {
                            ...
                            foreach (var chunk in CloseThinkingBlock(logger))
                                yield return chunk;
                        ...
                        var safeLength = GetSafeFlushLength(current, logger);
                        if (safeLength <= 0)
                            yield break;
                    ...
                    if (startIndex >= 0)
                    {
                        ...
                        foreach (var chunk in OpenThinkingBlock(logger))
                            yield return chunk;
                    ...
                    var flushLength = GetSafeFlushLength(current, logger);
                    if (flushLength <= 0)
                        yield break;
            ...
            {
                logger.LogInformation($"ended AppendTaggedContent text:{text} harmonyModel:{harmonyModel}");
            }
        }
        ...
        public static IEnumerable<string> Complete( bool harmonyModel, ILogger logger)
        {
            try
            {
                if (harmonyModel)
                {
                    foreach (var chunk in CompleteHarmonyContent(logger))
                        yield return chunk;
                    yield break;
                }

                foreach (var chunk in CompleteTaggedContent(logger))
                    yield return chunk;

                if (!emittedVisibleContent && emittedExplicitThinking)
                {
                    foreach (var chunk in EmitMissingFinalNotice(logger))
                        yield return chunk;
                }
            }
            finally
            {
                logger.LogInformation($"ended Complete harmonyModel:{harmonyModel}");
            }
        }
        ...
        public static IEnumerable<string> CompleteTaggedContent(ILogger logger)
        {
            ...
            {
                logger.LogInformation($"ended CompleteTaggedContent");
            }
        ...
        public static IEnumerable<string> CompleteHarmonyContent( ILogger logger)
        {
            try
            {
                if (harmonyBuffer.Length > 0)
                {
                    ...
                    if (!raw.Contains("<|", StringComparison.Ordinal))
                    {
                        foreach (var chunk in AppendTaggedContent(raw, true, logger))
                            yield return chunk;
                        foreach (var chunk in CompleteTaggedContent(logger))
                            yield return chunk;
                        yield break;
                    ...
                    foreach (var chunk in EmitHarmonyDeltas(raw, true, logger))
                        yield return chunk;
            ...
            {
                logger.LogInformation($"ended CompleteHarmonyContent");
            }
        ...
        public static IEnumerable<string> EmitHarmonyDeltas(string raw, bool harmonyModel, ILogger logger)
        {
            try
            {
                var thinking = ExtractHarmonyThinkingText(raw, logger);
                ...
                var final = ExtractHarmonyFinalText(raw, logger);
            ...
            {
                logger.LogInformation($"ended EmitHarmonyDeltas raw {raw} harmonyModel {harmonyModel}");
            }
        }
        ...
        public static IEnumerable<string> EmitHarmonyDeltas(string raw, ILogger logger)
        {
            ...
            {
                logger.LogInformation($"ended EmitHarmonyDeltas raw {raw}");
            }
        }
        ...
        public static IEnumerable<string> OpenThinkingBlock( ILogger logger)
        {
            ...
            {
                logger.LogInformation($"ended OpenThinkingBlock");
            }
        }
        ...
        public static IEnumerable<string> CloseThinkingBlock( ILogger logger)
        {
            ...
            {
                logger.LogInformation($"ended CloseThinkingBlock");
            }
        }
        ...
        public static IEnumerable<string> EmitMissingFinalNotice(ILogger logger)
        {
            ...
            {
                logger.LogInformation($"ended EmitMissingFinalNotice");
            }
        ...
        public static string CleanHarmonyText(string text, ILogger logger)
        {
            try
            {
                var cleaned = HarmonyMarkerPatternNew().Replace(WebUtility.HtmlDecode(text), string.Empty);
        ...
        public static string? NormalizeVisibleContent(string model, string? content, ILogger logger)
        {
            try
            {
                ...
                if (CouncilChatStringFunctions.IsHarmonyModel(model,logger))
                {
                    ...
                    text = HarmonyMarkerPatternNew().Replace(text, string.Empty);
                }

                text = ThinkTagPatternNew().Replace(text, string.Empty);
                return text.Trim();
            }
            catch (Exception ex)
            {
        ...
        public static string? ExtractHarmonyThinking(string model, string? content, ILogger logger)
        {
            try
            {
                ...
                var matches = HarmonyThinkingPatternNew().Matches(content);
                if (matches.Count == 0)
                    return null;
                ...
                var thinking = string.Join(
                    Environment.NewLine,
                    matches
                        .Select(match => HarmonyMarkerPatternNew().Replace(match.Groups["content"].Value, string.Empty).Trim())
                        .Where(text => !string.IsNullOrWhiteSpace(text)));
        ...
        public static string FormatVisibleResponse(string model, string? content, string? thinking, ILogger logger)
        {
            try
            {
                ...
                if (!string.IsNullOrWhiteSpace(normalizedContent))
                    ...
                    builder.AppendLine(GlobalVariableSlopCollectionToRemove.MissingFinalAnswerNotice);
