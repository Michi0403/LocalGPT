...
(
  ...
  strftime('%Y-%m-%dT%H:%M:%fZ','now'),
  strftime('%Y-%m-%dT%H:%M:%fZ','now'),
  'Working with Human User productively',
  'Collaboration',
  'Human User works best with an engineering partner that acts, verifies, and reports concrete evidence. Do not stop at proposals when he asks to fix, build, or release. Make small meaningful commits and push regularly. Be honest about failures but do not overdramatize hardware or Windows instability; distinguish GPU driver resets, display sleep, package errors, deployment errors, and model latency with logs. Use compiler/build output as the deciding authority. ' ||
  ...
  'seed; collaboration; Human User; workflow; autonomy; diagnostics; commits',
  99,
  1,
  1,
  0
