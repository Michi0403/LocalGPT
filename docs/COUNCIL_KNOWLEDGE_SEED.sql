...
-- Reconstructed from the user-supplied historical SQL seed and updated only for the current CouncilKnowledgeEntries schema.
-- This is executable SQLite repair/backup DML. It is intentionally idempotent: INSERT OR IGNORE preserves existing rows and user edits with the same stable Id.
-- LocalGPT packages and references this file, but application startup does not automatically execute arbitrary SQL files.
-- The /database frontend currently provides structured table editing, not a generic raw-SQL file executor.

INSERT OR IGNORE INTO "CouncilKnowledgeEntries"
("Id", "CreatedAtUtc", "UpdatedAtUtc", "Topic", "Scope", "Content", "Source", "HelpfulSources", "Tags", "Confidence", "VerificationStatus", "ReviewStatus", "LastVerifiedAtUtc", "StalenessReason", "StalenessDetectedBy", "SourceHash", "IsUserApproved", "IsPinned", "IsArchived")
VALUES
(
  ...
  '',
  '',
  'A9FE2527A3CFC7CA3464B13C7263386C7F675204DEB85C47E41F4CF7625324A2',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '09E5DC89A7F5CE14CE1BEA58011FF913747E1775716A6740F424931132E6931C',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  'C712CDFCB8F1F2F70AE0E56909AFCAA936B5C84FA40A417414FDDEA23060ADF1',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '54C465AC6EF1675A3083ECFE21BA89F991F6CB07D01386D9DA8DDE703CDC3DBB',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '171BB66BB2B8060475252B75FCCFA5BF6E7D0368D0FCA845B9C636A510A6E133',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '801CB0C2606491118F1A33F287C1F093DC40FA8E6FC99669AAAB3DBB5609C0B8',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '3A339DD9EC95BB2247BC5FCD2AEAE79A9A8F17EC251FED447848DBA9D59B5BB3',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '8F1F67124A5B6A2B941E653EA4882DFB3F56FCC3C2075E00A60D8B6C2BCDF203',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  'B88A8181F93572EAD16A81746CB7D6686873793AE2F5B84DC89B981EF944C935',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '53128750674AAD37FA6B10770E4BBF0C3D8EF665D7CF03B1E87EA5873EA1D130',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  'D2AD954FDA2832DC9F4B27772C3CD5EEF968750D9FDCC639F336A35AC44D6861',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '731B1369A4B82BE797EFEAF243BD2EDACB18572A5D5B56F50D7EAC048C8910D4',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '2D16F0069FC245B28C30A853ECD9AFFDF8831A2D13345893EEB6933221A0EF52',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  'E5C7BF9C6E1EA07AA95C0ECF43201F1349B5E84609193710D2CED40E9FF5756D',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '8C52AAE05C770382732EA6A06C53AA2CE71E7B562C7B9BB2B143D8B2B0017AEE',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  'A250424435451BC89AF42B713F9A89BEAF26F6C96C8AFF3264CA565B5D87C578',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '92F6554103E748F0DA410E7B67B681804802EFAF8B52A99008D7BE07AFC347DE',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  'C21F6447565EBF99148D34DEA06A005FB83109A9301AEEC59ADAB5F78363A5CE',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '9ABC069CC7FC6C5E4FC6DD52E88BF553E6481110EA3223E66C502E454AF6DE8A',
  1,
  1,
  0
);
...
(
  ...
  'Whole-project generation must classify the archetype before writing files. The supported project_kind values include fabric_mod, neoforge_mod, paper_plugin, datapack, localgpt_feature, and dotnet_service. Every whole project must include PROJECT_INDEX.md, ARCHITECTURE.md, BUILD_AND_RUN.md, .localgpt-generation.json, and a platform-correct source/resource layout. PROJECT_INDEX.md must explain purpose, entry points, generated files, build/run commands, and validation status. Reject generic folder soup, missing index/home routes, string-builder fake Razor pages, wrong platform metadata, and any claim of build success without command output.',
  ...
  '',
  '',
  '2CD44A577AF79641A48B6348BE30897C5A6A2252A419047F14B94EA43A6FDC90',
  1,
  1,
  0
);
...
(
  ...
  '.NET Architecture',
  'Use Microsoft .NET architecture guidance to decide shape before code. Prefer a cohesive Blazor/ASP.NET Core app when a feature does not need independent deployment. Introduce service-oriented separation only around real boundaries such as independent scaling, external runner adapters, background work, downloads, reporting/document generation, or integrations. Keep UI interaction in Razor components and business/native/data work in injected services. Use appsettings for bootstrap/runtime configuration and EF/SQLite for durable user/application state. Include diagnostics or health checks for runtime features. Design APIs and models with clear naming, stable contracts, debuggability, and future evolution in mind.',
  'Microsoft Learn source-backed seed',
  'Architecture overview: https://learn.microsoft.com/en-us/dotnet/architecture/; Modern ASP.NET Core web apps: https://learn.microsoft.com/en-us/dotnet/architecture/modern-web-apps-azure/; Modern Web App pattern: https://learn.microsoft.com/en-us/azure/architecture/web-apps/guides/enterprise-app-patterns/modern-web-app/dotnet/guidance; Blazor architecture guide: https://learn.microsoft.com/en-us/dotnet/architecture/blazor-for-web-forms-developers/; Framework design guidelines: https://learn.microsoft.com/en-us/dotnet/standard/design-guidelines/; Library guidance: https://learn.microsoft.com/en-us/dotnet/standard/library-guidance/',
  ...
  '',
  '',
  '94F3E7D8B5C8E2BFAA2D3187B9A3ADA5DCC6B3C14F09DB7295B4CCB4481FC5A6',
  1,
  1,
  0
);
...
(
  ...
  'Repository Hygiene',
  'Physical source formatting is a hard quality gate, not an editor soft-wrap preference. Program.cs, NativeCommandRunner.cs, AiContextBootstrapService.cs, README.md, and other tracked source/docs must keep normal raw newline counts and avoid giant physical lines. Run build/Assert-SourceFormatting.ps1 before commits. GitHub Actions workflow .github/workflows/source-hygiene.yml runs the same guard on push and pull request for tracked .cs, .razor, .md, .ps1, and .json files.',
  'LocalGPT workflow memory',
  ...
  '',
  '',
  'DFF3DAA9D97D329D444C7FBA97F129991D256A927567429535CA955EDABA30DF',
  1,
  1,
  0
);
...
(
  ...
  'Minecraft Builder',
  'Before generating Fabric, NeoForge, Paper, or datapack workspaces, call /__diag/minecraft/dependency-version or use MinecraftDependencyVersionCatalog. It returns requested/matched Minecraft versions, Java/Gradle versions, Fabric loader/API, NeoForge, Paper API, datapack pack_format, exact-match flags, and NeedsVerification. Fallback mappings are allowed for smoke tests but must be source-checked against official Fabric, NeoForge, Paper, Gradle, and Minecraft documentation before release or friend testing.',
  'LocalGPT workflow memory',
  ...
  '',
  '',
  '3CA575CBC408EFE9EBE1C931101B4D185771AFC7EAD5C458A398E3070961CB02',
  1,
  1,
  0
);
...
(
  ...
  'Blazor Design',
  'Use Bootstrap v5 for macro layout and DevExpress Blazor for real application controls. Bootstrap owns containers, rows, columns, gutters, spacing, flex alignment, responsive breakpoints, and small utility classes. DevExpress owns grids, forms, editors, toolbars, menus, navigation widgets, upload, charts, reports, dialogs, AI chat, and document/file workflows. Generated pages should feel like working application screens: compact headings, helpful tooltips, visible loading/error/success states, and real backend download links when files are generated.',
  ...
  '',
  '',
  '3607355BFA2751E50AFD3DE61AD1A190AAB6F97130902BB88919BE8AF1F8AB7C',
  1,
  1,
  0
);
...
(
  ...
  'DevExpress Blazor',
  'For new generated Blazor solutions, start from official project-template shapes before inventing architecture. Use the DevExpress Blazor Template Kit as a model for a themed shell, Bootstrap stylesheet choice, optional Open Iconic resources, ready pages, and component demos. Use Microsoft Blazor templates or official samples for base hosting structure. Pick DevExpress components by workflow: DxGrid for editable tabular data, DxFormLayout for settings and forms, DxToolbar/DxMenu/DxTreeView/DxTabs/DxDrawer for navigation/actions, DxLoadingPanel for long work, and DxAIChat for model conversations.',
  ...
  '',
  '',
  '1DFAAF87306D544E85F81CD42D85DA082FCAA5C2202A06FF568FB06A7B13714B',
  1,
  1,
  0
);
...
(
  ...
  'Blazor Design',
  'When generating navigation icons, create two SVG styles for every concept: a line icon for the default state and a solid or duotone icon for hover, active, selected, or compact states. Use a square viewBox, currentColor, consistent visual weight, short title text, no embedded text, no gradients, no decorative blobs, and readable geometry at 16px and 24px. Use DevExpress IconUrl or IconCssClass when icons belong to DevExpress navigation components; otherwise use img aria-hidden=true inside Bootstrap navigation with visible text labels.',
  ...
  '',
  '',
  '298579D5C626BC1D4A3E5F946C88644D64067B6315B50A1D5FF188D7D3579EB8',
  1,
  1,
  0
);
...
(
  ...
  '.NET Samples',
  'Treat dotnet/samples as official sample code referenced by .NET documentation. Use its focused sample families as evidence for project/API shape: csharp for language features, async/async-and-await for task/cancellation patterns, core for SDK-style .NET structure, standard/data/sqlite for SQLite basics, github-actions/DotNet.GitHubAction for CI/action shape, msbuild for project customization, and azure/orleans/machine-learning/iot/windowsforms/wpf/framework only when the generated archetype really needs that platform. Do not copy sample snippets blindly into LocalGPT; combine focused sample evidence with Microsoft Learn architecture and the LocalGPT archetype contract.',
  ...
  '',
  '',
  'BA15A6AC4330EC5EBA549E0CC0EC70D20BB1C73DAE0546AEAF2E01E95E05547F',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '0F294E6C3A261BD166BAC19DC7466D987F2AAD97F27E51A072CA8677E800D6E3',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  'F0B2ED7FAEAE362804BE9FE6D8DB120754F3BA2302FDFAEDDEFE345F73B97E8D',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '5A3C42B78761BCB0373408ADAD01131FA9A928D5FEBA2099D51545F5E4EDD51C',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '35AC6302B591B3FF769E99D9D4B64AE872199F816C19DE658662C91201FC2A58',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  'CD03E3956A55A4873AA0E2DE1A6215FF16D3FF6D32A65F448C254D79DF98AACF',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '1D03BCDC4CAC5D53156D0CC9099FAD6B8690862F6C4EF4A7BA19A5FB64403E53',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '5457E75F1BBD3345E9CD529CD86FB1A6CA4F03F0C59FE4ECB467FF2C2F9DEE54',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '6BCEBC01DE49856CD377243D27F82B45428690A4F43D07C1E0DA691D932A033A',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '4B8DBEFAB2E398C4527CA7ADBCDD5D0F3D515FAB2AFCE939603C57BF6442C538',
  1,
  1,
  0
);
...
(
  ...
  'DXAiChat is expected to accept local context and return downloadable artifacts. Use the documented DevExpress native paperclip attachment surface: FileUploadEnabled, DxAIChatFileUploadSettings, AIChatUploadFileInfo, and the normal chat-client upload content path. Do not add a MessageSent handler unless intentionally replacing automatic AI Chat delivery with a complete manual response path; DevExpress documents that a custom MessageSent handler overrides automatic delivery. Text-like uploads and zip files should be decoded into bounded safe upload workspaces before asking for code, datapacks, or review; do not flood the model with an entire archive and never execute uploaded or extracted files. A separate custom upload control may exist only as an explicitly labeled fallback and must not be described as the built-in DevExpress attachment feature. If the user asks for .cs, .razor, .dll, solution zips, datapacks, or modpacks, return HTTP download links through /__artifacts/council/ or another safe GET route, not raw zip/binary text. Markdown/Harmony formatting must render final visible content as normal Markdown, especially top-level lists after model-thinking blocks.',
  'LocalGPT SQL seed from DXAiChat upload implementation',
  'Official DevExpress docs: https://docs.devexpress.com/Blazor/DevExpress.AIIntegration.Blazor.Chat.DxAIChat; local page: LocalGPTWebviewWrapper/LocalGPT/Components/Pages/Chat.razor; local artifact service: CouncilArtifactService; local route: /__artifacts/council/{fileName}.',
  ...
  '',
  '',
  '3939E237F7A4A356A5EE2AF752949B5EE014B5A4DE5F3C1A4B799B3687C97909',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  'B09620677E9928F72BA08C56D2C826D7A751E7BC0B5C39B35ABCC25DDF5F8650',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '217074415B6892C42C6ACE67FA2F03172BB43A1B594E00424789BFA46FDFFAA2',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '45F828AC0CA376806100452929BF4D85DFF25067D73400242AEF73900B723EBD',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '714F1F9A296BC611CB9348D0ACC6C7BC3ED9B062BA9E38C7B6BB9BEAF305B3AF',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  'DB4FDA5745FC0B4B1B8009BD02C70D41DB49F971CC3E5F73CE9BB0381D8EE708',
  1,
  1,
  0
);
...
(
  ...
  'LocalGPT SQL seed',
  'Local route: /__diag/learn-base/import imports compact source-backed fingerprints from C:\learnbaseforlocalgpt; local route: /__diag/benchmark/engineering scores generation tasks honestly.',
  ...
  '',
  '',
  '570FC884B2C25BB7D05C639EAE59B1BC79AF1AE19E2E5D75BBE410DA584629A5',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '58250D788FB450C294B86E82F52B4293BFDB7B65662370854C9D9416C3E83073',
  1,
  1,
  0
);
...
(
  ...
  'Local guide: docs/AI_HOST_DOTNET_BLAZOR_REBUILD_GUIDE.md; local source root: C:\learnbaseforlocalgpt\ollama-main; local route: /__diag/learn-base/import.',
  ...
  '',
  '',
  '9F80BE8B99F1C6211FB578790E0E799A31CD1EE74326A5AD4E65DD46C0E6403F',
  1,
  1,
  0
);
...
(
  ...
  'Local source root: C:\learnbaseforlocalgpt\Blazor-25.2\Blazor-25.2\demo; local guide: docs/AI_HOST_DOTNET_BLAZOR_REBUILD_GUIDE.md; local route: /__diag/blazor-devexpress-guidance.',
  ...
  '',
  '',
  '583B9EF8620329265FD5B0B2ADEBE0B22714A7E2DBA56EDB2FD21A8780D40B91',
  1,
  1,
  0
);
...
(
  ...
  'LocalGPT SQL seed from local source scan',
  'Local source roots: C:\learnbaseforlocalgpt\videocutter and C:\learnbaseforlocalgpt\Jezzifa; local guide: docs/AI_HOST_DOTNET_BLAZOR_REBUILD_GUIDE.md.',
  ...
  '',
  '',
  'F511517CA206DA42715E438E2344D410269B957930C0F4C0EDC6BF6E248490F1',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '35093819FAE095D858137715AE6AF97ED5503E9901BDCD9CC4E09A75F4FCB12E',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '6D5A0C4A7142960146389B02AD328002B3A4885B5C72117AEBD034844F44924E',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  'A7608FF0BDE8EC0D6FC18659B8650FF4932FFAF135FC46BF336EEFF2C5AB134C',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '08320850BAF3A76F8C10AA03FAE644AEEF4FF23908483332CF2B06D4C170019B',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  'EF06D291D62A7A7ECB3E77DED186F6A97D6CBC1E2F0D784EA023CF68483E91FF',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '98F80A1FD79E5EE452904CEE1E272EE8B9A14C8F189FFC74F599EE9C90DE322E',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  'E2728ABBA19151D6D0E79162B767183709AC64A9700A90AA929C88600A4BD6C8',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  'D8628E992B11E16A09C15E689629FF10936C180293342AB4A28324889B9CF1D2',
  1,
  1,
  0
);
...
(
  ...
  'Microsoft Learn: https://learn.microsoft.com/microsoft-edge/webview2/how-to/webdriver; local page: Components/Pages/TestLab.razor; local route: /__diag/frontend-test-guidance; local learn-base request: C:\learnbaseforlocalgpt\AutomatedDiscordLogin-master.',
  ...
  '',
  '',
  'CA2C1128F7DEA6C85CE344DE04811C20975C142E57312038122D3C07FDE2176F',
  1,
  1,
  0
);
...
(
  ...
  'Generated code should be treated as a live sandbox workspace before it becomes a zip. The AI Council should discover the current host and workspace with /__diag/artifact-workspaces, list files with /__diag/artifact-workspace/{workspaceName}/files, read or save text source files through /__diag/artifact-workspace/{workspaceName}/file, and refresh the zip only through /__diag/artifact-workspace/{workspaceName}/zip. The council should cite real /__artifacts/council/ download links and the actual workspace path rather than inventing host names or paths. Models may generate, inspect, edit, compile, validate, and package sandbox artifacts, but they must not launch generated programs, scripts, installers, or solutions by themselves. When a build produces an executable, script, or solution to open, the model must summarize local system impact such as files read/written, commands run, network/model downloads, deletes, services started, and settings changed, then ask the user to approve or manually start it. For LocalGPT package/backend smoke tests, discover the active loopback URL from %LOCALAPPDATA%/LocalGPT/runtime/server.json because the app chooses a free port at startup. Set LOCALGPT_STARTUP_TRACE=1 only while diagnosing startup; it prints phase markers around configuration, service registration, middleware, and runtime endpoint creation.',
  'LocalGPT runtime policy seed',
  'Routes: /__diag/artifact-workspaces, /__diag/artifact-workspace/{workspaceName}/files, /__diag/artifact-workspace/{workspaceName}/file, /__diag/artifact-workspace/{workspaceName}/zip, /__artifacts/council/{fileName}; UI: Test Lab generated workspace panel; service: AiContextBootstrapService runtime identity briefing. Runtime file: %LOCALAPPDATA%/LocalGPT/runtime/server.json.',
  ...
  '',
  '',
  'BD77B87E3A99C66006655FB8C3167B9AFEEB9BDE0FFCBC7BF0670CBA2C1DDCAC',
  1,
  1,
  0
);
...
(
  ...
  'LocalGPT is designed for single-user desktop/WebView2 use on loopback. This gives a real privacy advantage because prompts, source code, chat memory, generated artifacts, logs, and local model calls can stay on the user machine. Do not claim that local means no security concerns. The remaining risk is local capability risk: file access, native commands, generated scripts/projects, sensitive SQLite memory, imported knowledge, and optional cloud endpoints. Keep command execution behind policy services, require explicit user permission before integrating generated code into LocalGPT, inspect generated scripts before running them, and mark imported knowledge as verified or unverified. If LocalGPT is hosted for coworkers or any untrusted network, treat it as a normal web app and require authentication, authorization, CSRF protection, TLS, rate limits, audit logs, command restrictions, workspace isolation, secrets management, and database retention rules.',
  'LocalGPT security review seed',
  'Top-level doc: SECURITY.md. README section: Security Model. Local code: Program.cs binds the desktop host to 127.0.0.1 by default. Related local docs: AGENTS.md and docs/LOCALGPT_WORKFLOW_MEMORY.md.',
  ...
  '',
  '',
  'B64423588D18D69C2F4EFC432BE4CFA1DAC3A2B7C064193515AE78C934B46CAC',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '3A496E0CAB5B5E3B837BD0DE62D91EB1B89F024C2B1E411DCE5FD26751A94B2A',
  1,
  1,
  0
);
...
(
  ...
  '',
  '',
  '1BDC7D5848A493B99BD16767744601ED5D2881B68772951438265EAE865F586A',
  1,
  1,
  0
);
