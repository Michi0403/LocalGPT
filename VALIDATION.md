# LocalGPT 2.3.2 validation

LocalGPT 2.3.2 is a source-validated Kawaii documentation-layout milestone. The owner-side Windows build, application runtime, publish, installer, browser, and GitHub Actions runs remain authoritative.
...
- Application, installer, desktop wrapper, documentation metadata, and PDF naming are aligned to **2.3.2**.
