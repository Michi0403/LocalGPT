...
{
    /// <summary>
    /// Benchmarks every distinct benchmark-capable provider-qualified target in the request at the caller-configured measured token points,
    /// persists Low/Normal/High/Expert/Max hardware profiles, and returns bounded evidence for later social review rounds.
    /// </summary>
