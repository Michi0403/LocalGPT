    ...
    IDxAiFunctionJsonService json) : IDxAiFunctionHandler
{
    ...
    public DxaichatFunctionInfo Descriptor { get; } = new(
        ...
        /// <summary>
        /// Stores the internal parameter schema JSON state used by <see cref="GetEmbeddedHardwareCatalogFunction"/> while executing its surrounding workflow.
        /// </summary>
    ...
    IEmbeddedWiringService wiring) : IDxAiFunctionHandler
{
    ...
    public DxaichatFunctionInfo Descriptor { get; } = new(
        ...
        /// <summary>
        /// Stores the internal parameter schema JSON state used by <see cref="CreateEmbeddedWiringDraftFunction"/> while executing its surrounding workflow.
        /// </summary>
        IsReadOnly: true, AvailableToAi: true, SupportsDirectInvocation: true, SupportsAutomaticInvocation: true, Source: "DIHandler",
    ...
    IEmbeddedWiringService wiring) : IDxAiFunctionHandler
{
    ...
    public DxaichatFunctionInfo Descriptor { get; } = new(
        ...
        /// <summary>
        /// Stores the internal parameter schema JSON state used by <see cref="ValidateEmbeddedWiringFunction"/> while executing its surrounding workflow.
        /// </summary>
        IsReadOnly: true, AvailableToAi: true, SupportsDirectInvocation: true, SupportsAutomaticInvocation: true, Source: "DIHandler",
    ...
    ILogger<PlanEmbeddedFirmwareFunction> logger) : IDxAiFunctionHandler
{
    ...
    public DxaichatFunctionInfo Descriptor { get; } = new(
        ...
        /// <summary>
        /// Stores the internal parameter schema JSON state used by <see cref="PlanEmbeddedFirmwareFunction"/> while executing its surrounding workflow.
        /// </summary>
        IsReadOnly: true, AvailableToAi: true, SupportsDirectInvocation: true, SupportsAutomaticInvocation: true, Source: "DIHandler",
    ...
    ILogger<CreateEmbeddedFirmwareArtifactsFunction> logger) : IDxAiFunctionHandler
{
    ...
    public DxaichatFunctionInfo Descriptor { get; } = new(
        ...
        /// <summary>
        /// Stores the internal parameter schema JSON state used by <see cref="CreateEmbeddedFirmwareArtifactsFunction"/> while executing its surrounding workflow.
        /// </summary>
    ...
    IEmbeddedTelemetryBridgeService bridge) : IDxAiFunctionHandler
{
    ...
    public DxaichatFunctionInfo Descriptor { get; } = new(
        ...
        /// <summary>
        /// Stores the internal parameter schema JSON state used by <see cref="PreviewEmbeddedTelemetryFunction"/> while executing its surrounding workflow.
        /// </summary>
        IsReadOnly: true, AvailableToAi: true, SupportsDirectInvocation: true, SupportsAutomaticInvocation: true, Source: "DIHandler",
    ...
    IEmbeddedTelemetryBridgeService bridge) : IDxAiFunctionHandler
{
    ...
    public DxaichatFunctionInfo Descriptor { get; } = new(
        ...
        /// <summary>
        /// Stores the internal parameter schema JSON state used by <see cref="PreviewEmbeddedOneWireEnvelopeFunction"/> while executing its surrounding workflow.
        /// </summary>
    ...
    IEmbeddedTelemetryIngressService ingress) : IDxAiFunctionHandler
{
    ...
    public DxaichatFunctionInfo Descriptor { get; } = new(
        ...
        /// <summary>
        /// Stores the internal parameter schema JSON state used by <see cref="PublishEmbeddedTelemetryFunction"/> while executing its surrounding workflow.
        /// </summary>
