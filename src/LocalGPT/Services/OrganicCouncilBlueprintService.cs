    ...
    ILogger<OrganicCouncilBlueprintService> logger) : IOrganicCouncilBlueprintService
{
    ...
    try
    {
        return teamConfigurations.GetTeamsAsync(false, cancellationToken);
    }
    catch (Exception __serviceMethodException)
    {
        if (__serviceMethodException is OperationCanceledException)
            logger.LogDebug(__serviceMethodException, $"Service method {nameof(OrganicCouncilBlueprintService)}.{nameof(GetTeamsAsync)} was canceled.");
        else
            logger.LogError(__serviceMethodException, $"Service method {nameof(OrganicCouncilBlueprintService)}.{nameof(GetTeamsAsync)} failed.");
        throw;
    }
}
    ...
    try
    {
        return teamConfigurations.FindTeamAsync(key, cancellationToken);
    }
    catch (Exception __serviceMethodException)
    {
        if (__serviceMethodException is OperationCanceledException)
            logger.LogDebug(__serviceMethodException, $"Service method {nameof(OrganicCouncilBlueprintService)}.{nameof(FindTeamAsync)} was canceled.");
        else
            logger.LogError(__serviceMethodException, $"Service method {nameof(OrganicCouncilBlueprintService)}.{nameof(FindTeamAsync)} failed.");
        throw;
    }
}
    ...
    {
        if (__serviceMethodException is OperationCanceledException)
            logger.LogDebug(__serviceMethodException, $"Service method {nameof(OrganicCouncilBlueprintService)}.{nameof(BuildBriefingAsync)} was canceled.");
        else
            logger.LogError(__serviceMethodException, $"Service method {nameof(OrganicCouncilBlueprintService)}.{nameof(BuildBriefingAsync)} failed.");
        throw;
    }
}
    ...
    try
    {
        return RenderTemplate(team.ExpertPreparationPromptTemplate, team, request, preparation: string.Empty);
    }
    catch (Exception __serviceMethodException)
    {
        if (__serviceMethodException is OperationCanceledException)
            logger.LogDebug(__serviceMethodException, $"Service method {nameof(OrganicCouncilBlueprintService)}.{nameof(BuildExpertPreparationPrompt)} was canceled.");
        else
            logger.LogError(__serviceMethodException, $"Service method {nameof(OrganicCouncilBlueprintService)}.{nameof(BuildExpertPreparationPrompt)} failed.");
        throw;
    }
}
    ...
    try
    {
        return RenderTemplate(team.LeaderSynthesisPromptTemplate, team, request, preparation);
    }
    catch (Exception __serviceMethodException)
    {
        if (__serviceMethodException is OperationCanceledException)
            logger.LogDebug(__serviceMethodException, $"Service method {nameof(OrganicCouncilBlueprintService)}.{nameof(BuildLeaderSynthesisPrompt)} was canceled.");
        else
            logger.LogError(__serviceMethodException, $"Service method {nameof(OrganicCouncilBlueprintService)}.{nameof(BuildLeaderSynthesisPrompt)} failed.");
        throw;
    }
}
    ...
    {
        if (__serviceMethodException is OperationCanceledException)
            logger.LogDebug(__serviceMethodException, $"Service method {nameof(OrganicCouncilBlueprintService)}.{nameof(RenderTemplate)} was canceled.");
        else
            logger.LogError(__serviceMethodException, $"Service method {nameof(OrganicCouncilBlueprintService)}.{nameof(RenderTemplate)} failed.");
        throw;
    }
}
