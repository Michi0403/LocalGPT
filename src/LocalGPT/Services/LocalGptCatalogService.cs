...
namespace LocalGPT.Services
{
    ...
    try
    {
                ...
                [
                    ...
                    new("Council starter: calibrate installed models", "Run the recommended first-install model calibration", "Start the maintained Initial Hardware Calibration Benchmark Council. Keep the selected provider-qualified membership authoritative: exercise every selected Council member, deterministically benchmark every benchmark-capable selected member at four bounded points, preserve failures as coverage evidence, and store measured Low, Middle, High and Expert hardware profiles before synthesis. Do not sample representatives and do not overwrite unrelated approved presets.", "benchmark-council-start", ["adaptive-model-benchmark"], true),
