...
public sealed class GetLearningRoundSnapshotFunction(ILearningRoundService learning, ILogger<GetLearningRoundSnapshotFunction> logger) : IDxAiFunctionHandler
{
    ...
    public DxaichatFunctionInfo Descriptor { get; } = new(
        ...
        "Builds a bounded learning-round evidence snapshot from chat memory, logs, Council knowledge and database regexes; upload evidence remains available through the chat upload-workspace functions.",
