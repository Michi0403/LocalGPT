...
def main() -> int:
    ...
    require("CHANGELOG-v4.7.4-COUNCIL-CANCELLATION-DEBUG-REPAIR.md", f"# LocalGPT {VERSION}")
    require("VALIDATION-v4.7.4-source.md", f"# LocalGPT {VERSION} source validation")
    require("src/LocalGPT/Components/App.razor", "localgpt-game-console.js?v=4.7.4", "localgpt-chat-ui.js?v=4.7.4")
    require("src/LocalGPT/Services/InitialSetupAssistantService.cs", "LocalGPT/4.7.4")
    require("src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs", "LocalGPT/4.7.4")
    require("docs/index.md", "**Version 4.7.4**", "LocalGPT-4.7.4.pdf")
    require("docs/docfx.json", '"localgptVersion": "4.7.4"')
    require("docs/pdf/toc.yml", "LocalGPT-4.7.4.pdf")
    require("docs/pdf-cover.html", "LocalGPT 4.7.4 Documentation", "Version 4.7.4")
    ...
    print(f"LocalGPT {VERSION} release audit passed: expected Ollama ReadLineAsync cancellation is contained at the provider boundary and reclassified by Council code while prior Council, tournament, ASCII popup and InteractiveServer contracts remain present.")
    return 0
