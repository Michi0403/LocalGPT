...
import hashlib, sys
ROOT=Path(__file__).resolve().parents[1]; VERSION='4.5.0'
def read(rel):
 p=ROOT/rel
...
def main():
 ...
 req('RELEASE.md','# LocalGPT 4.5.0'); req('VALIDATION.md','# LocalGPT 4.5.0 source validation')
 req('CHANGELOG-v4.5.0-ASCII-COLOR-SYSTEM-SMALL-MODEL-GAME-AUTHORING.md','# LocalGPT 4.5.0')
 req('VALIDATION-v4.5.0-source.md','# LocalGPT 4.5.0 source validation')
 req('src/LocalGPT/Components/App.razor','localgpt-game-console.js?v=4.5.0')
 req('src/LocalGPT/Components/App.razor','localgpt-chat-ui.js?v=4.5.0')
 req('src/LocalGPT/Services/InitialSetupAssistantService.cs','LocalGPT/4.5.0')
 req('src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs','LocalGPT/4.5.0')
 req('docs/pdf-cover.html','LocalGPT 4.5.0 Documentation')
 req('docs/reference/ai-provider-installation.md','LocalGPT/4.5.0')
