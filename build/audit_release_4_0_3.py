#!/usr/bin/env python3
"""Source-only release checks for LocalGPT 4.0.3."""
...
for rel, needle in (
    ...
    ("VALIDATION-v4.0.3-source.md", "# LocalGPT 4.0.3 source validation"),
    ("CHANGELOG-v4.0.3-RELEASE-PARSER-RENDEZVOUS-REPAIR.md", "PowerShell release parser repair"),
):
    require(rel, needle)
...
# Windows Ollama profile retains the direct fast HTTP path while release identity moves to 4.0.3.
...
# 4.0.3 release parser, runtime identity and macOS update lifecycle.
...
if ERRORS:
    print("LocalGPT 4.0.3 source audit FAILED:")
    for error in ERRORS:
        print(f" - {error}")
    sys.exit(1)
print(
