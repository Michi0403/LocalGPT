...
def main() -> int:
    ...
    req("CHANGELOG-v4.5.9-SOURCE.md", f"# LocalGPT {VERSION}")
    req("VALIDATION-v4.5.9-source.md", f"# LocalGPT {VERSION} source validation")
    for marker in ["localgpt-game-console.js?v=4.5.9", "localgpt-chat-ui.js?v=4.5.9"]:
        req("src/LocalGPT/Components/App.razor", marker)
    req("src/LocalGPT/Services/InitialSetupAssistantService.cs", "LocalGPT/4.5.9")
    req("src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs", "LocalGPT/4.5.9")
    req("docs/index.md", "**Version 4.5.9**")
    req("docs/docfx.json", '"localgptVersion": "4.5.9"')
    ...
    print(f"LocalGPT {VERSION} release audit passed: completed freshness/rejoin/tournament/dropdown work, render topology and {checked} JS hashes are consistent.")
    return 0
