...
for relative in (
    ...
    version(relative, "4.1.4")

for relative, token in (
    ("docs/docfx.json", '"localgptVersion": "4.1.4"'),
    ("docs/pdf/toc.yml", "LocalGPT-4.1.4.pdf"),
    ("docs/pdf-cover.html", "LocalGPT 4.1.4 Documentation"),
    ("docs/index.md", "**Version 4.1.4**"),
    ("src/LocalGPT/Components/App.razor", "localgpt-chat-ui.js?v=4.1.4"),
    ("src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs", "LocalGPT/4.1.4"),
    ("src/LocalGPT/Services/InitialSetupAssistantService.cs", "LocalGPT/4.1.4"),
    ("docs/reference/ai-provider-installation.md", "LocalGPT/4.1.4"),
...
if failures:
    print("LocalGPT 4.1.4 release audit FAILED:")
    print("\n".join(f" - {failure}" for failure in failures))
    sys.exit(1)
print("LocalGPT 4.1.4 release audit passed: ConfigurationRoot namespace qualification is guarded while adaptive low-memory DocFX/PDF policy, provider management, Matrix operator controls, renderer affinity and earlier macOS signing/PDF protections remain intact.")
