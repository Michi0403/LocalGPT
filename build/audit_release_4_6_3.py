...
def main():
    ...
    req('CHANGELOG-v4.6.3-INSTALL-UI-INVARIANT-NUMERIC-REPAIR.md', f'# LocalGPT {VERSION}')
    req('VALIDATION-v4.6.3-source.md', f'# LocalGPT {VERSION} source validation')
    req('src/LocalGPT/Components/App.razor', 'localgpt-game-console.js?v=4.6.3')
    req('src/LocalGPT/Components/App.razor', 'localgpt-chat-ui.js?v=4.6.3')
    req('src/LocalGPT/Services/InitialSetupAssistantService.cs', 'LocalGPT/4.6.3')
    req('src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs', 'LocalGPT/4.6.3')
    req('docs/index.md', '**Version 4.6.3**')
    req('docs/docfx.json', '"localgptVersion": "4.6.3"')
    ...
    print(f'LocalGPT {VERSION} release audit passed: /install DevExpress styling, invariant numeric editors, CanIRun resolve/install actions, compact benchmark cards, prior feature wiring, lifetime repair and {checked} JS hashes are consistent.')
    return 0
