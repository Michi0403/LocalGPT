...
try:
    ...
    if data.get('build',{}).get('globalMetadata',{}).get('localgptVersion')!='3.6.9':
        errors.append('docs/docfx.json localgptVersion is not 3.6.9')
except Exception as exc: errors.append(f'docs/docfx.json JSON parse failed: {exc}')
req('docs/pdf/toc.yml','LocalGPT-3.6.9.pdf')
req('docs/index.md','**Version 3.6.9**')
req('RELEASE.md','# LocalGPT 3.6.9')
req('CHANGELOG-v3.6.9-RELEASE-RESUME-PDF-SIZE-CONTROL.md','Version advanced from 3.6.8 to 3.6.9')
req('VALIDATION-v3.6.9-source.md','# LocalGPT 3.6.9 source validation')
req('src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs','LocalGPT/3.6.9')
req('src/LocalGPT/Components/App.razor','localgpt-chat-ui.js?v=3.6.9')
...
if errors:
    print('LocalGPT 3.6.9 static release audit FAILED:')
    for e in errors: print(' -',e)
    raise SystemExit(1)
print('LocalGPT 3.6.9 source audit passed.')
