...
def main() -> int:
    # Version policy: no two-digit minor or patch segment. 4.4.4 is the maintained next line.
    ...
    release_markers = {
        ...
        "CHANGELOG-v4.4.4-DEVEXPRESS-RAZOR-CSSCLASS-BUILD-REPAIR.md": f"# LocalGPT {VERSION}",
        "VALIDATION-v4.4.4-source.md": f"# LocalGPT {VERSION} source validation",
        "docs/index.md": f"**Version {VERSION}**",
        "docs/docfx.json": f'"localgptVersion": "{VERSION}"',
        "docs/pdf/toc.yml": "LocalGPT-4.4.4.pdf",
        "src/LocalGPT/Components/App.razor": "localgpt-game-console.js?v=4.4.4",
    }
    ...
    for relative in current_metadata:
        forbid(read(relative), "4.4.3", f"stale current-version metadata in {relative}")

    print(
        f"LocalGPT {VERSION} release audit passed: Razor-safe DevExpress mode-button CssClass binding, required ASCII surface/popup lifetime, DevExpress console controls, "
