#!/usr/bin/env python3
"""Source-only release audit for LocalGPT 4.8.0. Never invokes dotnet, GitHub, installers, or project code."""
...
def main() -> int:
    ...
    require("src/LocalGPT/Components/App.razor", "localgpt-game-console.js?v=4.8.0", "localgpt-chat-ui.js?v=4.8.0")
    require("docs/index.md", "**Version 4.8.0**", "LocalGPT-4.8.0.pdf")
    require("docs/docfx.json", '"localgptVersion": "4.8.0"')
    require("docs/pdf/toc.yml", "LocalGPT-4.8.0.pdf")
    require("docs/pdf-cover.html", "LocalGPT 4.8.0 Documentation", "Version 4.8.0")
    require("CHANGELOG-v4.8.0-LOCAL-AI-TOOLCHAINS-ASCII-APPROVAL.md", "# LocalGPT 4.8.0")
    require("VALIDATION-v4.8.0-source.md", "# LocalGPT 4.8.0 source validation")
    ...
    print("LocalGPT 4.8.0 source audit: PASS")
    return 0
...
if __name__ == "__main__":
    try:
        ...
        print(f"LocalGPT 4.8.0 source audit: FAIL: {exc}", file=sys.stderr)
        raise
