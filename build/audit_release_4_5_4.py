...
def main() -> int:
    ...
    req("RELEASE.md", "# LocalGPT 4.5.4")
    req("VALIDATION.md", "# LocalGPT 4.5.4 source validation")
    req("CHANGELOG-v4.5.4-DEVEXPRESS-RAZOR-COMPILER-REPAIR.md", "# LocalGPT 4.5.4")
    req("VALIDATION-v4.5.4-source.md", "# LocalGPT 4.5.4 source validation")
    req("src/LocalGPT/Components/App.razor", "localgpt-game-console.js?v=4.5.4")
    req("src/LocalGPT/Components/App.razor", "localgpt-chat-ui.js?v=4.5.4")
    req("src/LocalGPT/Services/InitialSetupAssistantService.cs", "LocalGPT/4.5.4")
    req("src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs", "LocalGPT/4.5.4")
    req("docs/pdf-cover.html", "LocalGPT 4.5.4 Documentation")
    req("docs/index.md", "**Version 4.5.4**")
    req("docs/pdf/toc.yml", "LocalGPT-4.5.4.pdf")
    req("docs/reference/ai-provider-installation.md", "LocalGPT/4.5.4")
    ...
    print(
        f"LocalGPT {VERSION} release audit passed: release identity, reported Razor/DevExpress compiler repairs, "
