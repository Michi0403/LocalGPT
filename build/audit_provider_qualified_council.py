...
def main() -> int:
    ...
    models = text("LocalGPTWebviewWrapper/LocalGPT/BusinessObjects/ProviderModelModels.cs")
    benchmark_models = text("LocalGPTWebviewWrapper/LocalGPT/BusinessObjects/ProviderModelBenchmarkModels.cs")
    runtime = text("LocalGPTWebviewWrapper/LocalGPT/Services/ProviderModelRuntimeService.cs")
    benchmark = text("LocalGPTWebviewWrapper/LocalGPT/Services/ProviderModelBenchmarkService.cs")
    chat_factory = text("LocalGPTWebviewWrapper/LocalGPT/Services/ChatClientFactory.cs")
    council = text("LocalGPTWebviewWrapper/LocalGPT/Services/MultiModelCouncilService.cs")
    one_wire_execution = text("LocalGPTWebviewWrapper/LocalGPT/Services/OneWire/OneWireExecutionServices.cs")
    panel = text("LocalGPTWebviewWrapper/LocalGPT/Components/Shared/ProviderModelPanel.razor")
    batch_panel = text("LocalGPTWebviewWrapper/LocalGPT/Components/Shared/ProviderModelBenchmarkCouncilPanel.razor")
    chat = text("LocalGPTWebviewWrapper/LocalGPT/Components/Pages/Chat.razor")
    model_council = text("LocalGPTWebviewWrapper/LocalGPT/Components/Pages/ModelCouncil.razor")
    install = text("LocalGPTWebviewWrapper/LocalGPT/Components/Pages/Install.razor")
    wire = text("LocalGPTWebviewWrapper/LocalGPT.WireProtocolVersion/OneWireProtocolContracts.cs")
    ...
    contains("application patch version advanced", project, "<Version>2.3.2</Version>")
