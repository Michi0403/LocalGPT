...
def main() -> int:
    ...
    contains("adaptive benchmark prefers provider-qualified benchmark function", team_seeds, '"localgpt.models.benchmark.provider"')
    ...
    contains("adaptive benchmark receives performance preset save DXFunction", team_seeds, '"localgpt.hardware.performance.presets.save"')
    contains("adaptive benchmark receives performance preset apply DXFunction", team_seeds, '"localgpt.hardware.performance.presets.apply"')
    contains("adaptive benchmark receives performance preset delete DXFunction", team_seeds, '"localgpt.hardware.performance.presets.delete"')
    ...
    contains("adaptive benchmark team uses provider-qualified benchmark function", team_seeds, "localgpt.models.benchmark.provider")
