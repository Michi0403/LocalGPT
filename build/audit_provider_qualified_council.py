...
def main() -> int:
    ...
    contains("benchmark reviewer defaults prefer gpt-oss 20b", benchmark, 'name.Equals("gpt-oss:20b"')
    ...
    excludes("adaptive benchmark does not advertise performance preset save mutation", team_seeds.split('DisplayName = "Initial Hardware Calibration Benchmark"', 1)[1].split('private OrganicCouncilTeamDefinition CreateGameDirectorRuntimeTeam', 1)[0], '"localgpt.hardware.performance.presets.save"')
    excludes("adaptive benchmark does not advertise performance preset apply mutation", team_seeds.split('DisplayName = "Initial Hardware Calibration Benchmark"', 1)[1].split('private OrganicCouncilTeamDefinition CreateGameDirectorRuntimeTeam', 1)[0], '"localgpt.hardware.performance.presets.apply"')
    excludes("adaptive benchmark does not advertise performance preset delete mutation", team_seeds.split('DisplayName = "Initial Hardware Calibration Benchmark"', 1)[1].split('private OrganicCouncilTeamDefinition CreateGameDirectorRuntimeTeam', 1)[0], '"localgpt.hardware.performance.presets.delete"')
