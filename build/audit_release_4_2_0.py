...
for relative in (
    ...
    version(relative, "4.2.0")

for relative, token in (
    ("docs/docfx.json", '"localgptVersion": "4.2.0"'),
    ("docs/pdf/toc.yml", "LocalGPT-4.2.0.pdf"),
    ("docs/pdf-cover.html", "LocalGPT 4.2.0 Documentation"),
    ("docs/index.md", "**Version 4.2.0**"),
    ("src/LocalGPT/Components/App.razor", "localgpt-chat-ui.js?v=4.2.0"),
    ("src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs", "LocalGPT/4.2.0"),
    ("src/LocalGPT/Services/InitialSetupAssistantService.cs", "LocalGPT/4.2.0"),
    ("docs/reference/ai-provider-installation.md", "LocalGPT/4.2.0"),
...
if failures:
    print("LocalGPT 4.2.0 release audit FAILED:")
    print("\n".join(f" - {failure}" for failure in failures))
    sys.exit(1)
print("LocalGPT 4.2.0 release audit passed: live Ollama search expands official/community families through tags pages, stale profiles receive current offline aliases, CanIRun catalog comparison is independently bounded, the runtime workbench labels/layout are stable, and prior runtime/signing protections remain intact.")
