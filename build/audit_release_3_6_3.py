...
for rel in (
    ...
    require(rel, "<Version>3.6.3</Version>")
    ET.parse(ROOT / rel)
...
for rel, cls in (
    ...
    if "await Task.Yield();" not in block:
        raise AssertionError(f"{rel}: {cls} lacks explicit startup yield")
...
require("docs/docfx.json", '"localgptVersion": "3.6.3"')
require("docs/index.md", "**Version 3.6.3**")
require("docs/pdf/toc.yml", "LocalGPT-3.6.3.pdf")
require("CHANGELOG-v3.6.3-MACOS-DYNAMIC-PORT-STARTUP-ARCHITECTURE.md", "Version advanced from 3.6.2 to 3.6.3.")
require("RELEASE.md", "# LocalGPT 3.6.3")
print("LocalGPT 3.6.3 source audit passed.")
