...
for rel, token in [
    ('docs/index.md', '**Version 4.3.4**'),
    ('docs/pdf/toc.yml', 'LocalGPT-4.3.4.pdf'),
    ('docs/docfx.json', '"localgptVersion": "4.3.4"'),
    ('RELEASE.md', '# LocalGPT 4.3.4'),
    ('CHANGELOG-v4.3.4-CHAT-GAME-DOCUMENTATION-RECOVERY.md', 'LocalGPT 4.3.4'),
    ('VALIDATION-v4.3.4-source.md', '# LocalGPT 4.3.4 source validation'),
    ('src/LocalGPT/Components/App.razor', 'localgpt-game-console.js?v=4.3.4'),
    ('src/LocalGPT/Components/App.razor', 'localgpt-chat-ui.js?v=4.3.4'),
]:
    need(rel, token)
...
for token in [
    '4.3.4: compositor-safe dynamic sky handoff and bounded viewport effects.',
    '.localgpt-kawaii-sky {',
...
# Live-test regressions repaired in 4.3.4.
checks = {
...
if failures:
    print('LocalGPT 4.3.4 source audit failed:')
    for failure in failures:
        print('-', failure)
    sys.exit(1)
print('LocalGPT 4.3.4 source audit passed.')
