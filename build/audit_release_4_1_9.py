...
for relative in (
    ...
    version(relative, "4.1.9")

for relative, token in (
    ("docs/docfx.json", '"localgptVersion": "4.1.9"'),
    ("docs/pdf/toc.yml", "LocalGPT-4.1.9.pdf"),
    ("docs/pdf-cover.html", "LocalGPT 4.1.9 Documentation"),
    ("docs/index.md", "**Version 4.1.9**"),
    ("src/LocalGPT/Components/App.razor", "localgpt-chat-ui.js?v=4.1.9"),
    ("src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs", "LocalGPT/4.1.9"),
    ("src/LocalGPT/Services/InitialSetupAssistantService.cs", "LocalGPT/4.1.9"),
    ("docs/reference/ai-provider-installation.md", "LocalGPT/4.1.9"),
...
if failures:
    print("LocalGPT 4.1.9 release audit FAILED:")
    print("\n".join(f" - {failure}" for failure in failures))
    sys.exit(1)
print("LocalGPT 4.1.9 release audit passed: macOS bundle inspection is batched and reused for signing, eliminating the per-file native process amplification while preserving 4.1.8 model/catalog UI repairs, 4.1.7 runtime protections, signing and notarization contracts.")
