...
def main() -> int:
    ...
    req("RELEASE.md", "# LocalGPT 4.5.3")
    req("VALIDATION.md", "# LocalGPT 4.5.3 source validation")
    req("CHANGELOG-v4.5.3-WINDOWS-DEVEXPRESS-COMPILE-REPAIR.md", "# LocalGPT 4.5.3")
    req("VALIDATION-v4.5.3-source.md", "# LocalGPT 4.5.3 source validation")
    req("src/LocalGPT/Components/App.razor", "localgpt-game-console.js?v=4.5.3")
    req("src/LocalGPT/Components/App.razor", "localgpt-chat-ui.js?v=4.5.3")
    req("src/LocalGPT/Services/InitialSetupAssistantService.cs", "LocalGPT/4.5.3")
    req("src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs", "LocalGPT/4.5.3")
    req("docs/pdf-cover.html", "LocalGPT 4.5.3 Documentation")
    req("docs/index.md", "**Version 4.5.3**")
    req("docs/pdf/toc.yml", "LocalGPT-4.5.3.pdf")
    req("docs/reference/ai-provider-installation.md", "LocalGPT/4.5.3")
    ...
    req("src/LocalGPT/Components/Layout/MainLayout.razor", 'ValueChanged="@((string value) => OnCultureChanged(value))"')
    req("src/LocalGPT/Components/Layout/CouncilSpoolerPanel.razor", 'ValueChanged="@((CouncilSpoolerSnapshot? run) => SelectRun(run))"')
    req("src/LocalGPT/Components/Layout/HumanCollaborationInbox.razor", 'CssClass="@(PendingCount > 0 ? "human-inbox-launcher has-pending" : "human-inbox-launcher")"')
    req("src/LocalGPT/Components/Pages/CouncilTeams.razor", 'CheckedChanged="@((bool value) => ToggleRuntimeClass')
