...
for relative in (
    ...
    version(relative, "4.1.5")

for relative, token in (
    ("docs/docfx.json", '"localgptVersion": "4.1.5"'),
    ("docs/pdf/toc.yml", "LocalGPT-4.1.5.pdf"),
    ("docs/pdf-cover.html", "LocalGPT 4.1.5 Documentation"),
    ("docs/index.md", "**Version 4.1.5**"),
    ("src/LocalGPT/Components/App.razor", "localgpt-chat-ui.js?v=4.1.5"),
    ("src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs", "LocalGPT/4.1.5"),
    ("src/LocalGPT/Services/InitialSetupAssistantService.cs", "LocalGPT/4.1.5"),
    ("docs/reference/ai-provider-installation.md", "LocalGPT/4.1.5"),
...
if failures:
    print("LocalGPT 4.1.5 release audit FAILED:")
    print("\n".join(f" - {failure}" for failure in failures))
    sys.exit(1)
print("LocalGPT 4.1.5 release audit passed: bounded browser chunk recovery and no-monolithic-fallback policy are guarded while ConfigurationRoot qualification, adaptive low-memory documentation, provider management, Matrix controls, renderer affinity and earlier macOS protections remain intact.")
