...
try:
    ...
    if data.get('build',{}).get('globalMetadata',{}).get('localgptVersion')!='3.7.6':
        errors.append('docs/docfx.json localgptVersion is not 3.7.6')
except Exception as exc: errors.append(f'docs/docfx.json JSON parse failed: {exc}')
req('docs/pdf/toc.yml','LocalGPT-3.7.6.pdf')
req('docs/index.md','**Version 3.7.6**')
req('RELEASE.md','# LocalGPT 3.7.6')
req('CHANGELOG-v3.7.6-CHUNKED-PDF-RELEASE-VALIDATION.md','html-browser-chunked')
req('VALIDATION-v3.7.6-source.md','# LocalGPT 3.7.6 source validation')
req('src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs','LocalGPT/3.7.6')
req('src/LocalGPT/Components/App.razor','localgpt-chat-ui.js?v=3.7.6')
...
# 3.7.6 regression: the release/development validators must accept the adaptive chunked browser PDF
...
if errors:
    print('LocalGPT 3.7.6 static release audit FAILED:')
    for e in errors: print(' -',e)
    raise SystemExit(1)
print('LocalGPT 3.7.6 source audit passed.')
