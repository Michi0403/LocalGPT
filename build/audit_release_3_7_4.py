...
try:
    ...
    if data.get('build',{}).get('globalMetadata',{}).get('localgptVersion')!='3.7.4':
        errors.append('docs/docfx.json localgptVersion is not 3.7.4')
except Exception as exc: errors.append(f'docs/docfx.json JSON parse failed: {exc}')
req('docs/pdf/toc.yml','LocalGPT-3.7.4.pdf')
req('docs/index.md','**Version 3.7.4**')
req('RELEASE.md','# LocalGPT 3.7.4')
req('CHANGELOG-v3.7.4-ADAPTIVE-MANAGED-PDF-PIPELINE.md','LocalGPT.ReleasePackaging')
req('VALIDATION-v3.7.4-source.md','# LocalGPT 3.7.4 source validation')
req('src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs','LocalGPT/3.7.4')
req('src/LocalGPT/Components/App.razor','localgpt-chat-ui.js?v=3.7.4')
...
if errors:
    print('LocalGPT 3.7.4 static release audit FAILED:')
    for e in errors: print(' -',e)
    raise SystemExit(1)
print('LocalGPT 3.7.4 source audit passed.')
