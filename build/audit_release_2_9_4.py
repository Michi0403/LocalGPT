...
try:
    ...
    require(cfg,'private const int CurrentSeedVersion = 26;'); require(cfg,'Recovered supplied Council seed')
    ...
    print('LocalGPT 2.9.4 role-task authority regression audit passed under 2.9.9.')
