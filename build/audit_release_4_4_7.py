...
def main() -> int:
    ...
    release_markers = {
        ...
        "CHANGELOG-v4.4.7-JAVASCRIPT-DIAGNOSTICS-MANIFEST-REPAIR.md": f"# LocalGPT {VERSION}",
        "VALIDATION-v4.4.7-source.md": f"# LocalGPT {VERSION} source validation",
        "docs/index.md": f"**Version {VERSION}**",
        "docs/docfx.json": f'"localgptVersion": "{VERSION}"',
        "docs/pdf/toc.yml": "LocalGPT-4.4.7.pdf",
        "src/LocalGPT/Components/App.razor": "localgpt-game-console.js?v=4.4.7",
    }
