...
def main() -> int:
    ...
    req("RELEASE.md", "# LocalGPT 4.5.5")
    req("VALIDATION.md", "# LocalGPT 4.5.5 source validation")
    req("CHANGELOG-v4.5.5-XML-DOCUMENTATION-WARNING-CLEANUP.md", "# LocalGPT 4.5.5")
    req("VALIDATION-v4.5.5-source.md", "# LocalGPT 4.5.5 source validation")
    req("src/LocalGPT/Components/App.razor", "localgpt-game-console.js?v=4.5.5")
    req("src/LocalGPT/Components/App.razor", "localgpt-chat-ui.js?v=4.5.5")
    req("src/LocalGPT/Services/InitialSetupAssistantService.cs", "LocalGPT/4.5.5")
    req("src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs", "LocalGPT/4.5.5")
    req("docs/pdf-cover.html", "LocalGPT 4.5.5 Documentation")
    req("docs/index.md", "**Version 4.5.5**")
    req("docs/pdf/toc.yml", "LocalGPT-4.5.5.pdf")
    req("docs/reference/ai-provider-installation.md", "LocalGPT/4.5.5")
    ...
    print(
        f"LocalGPT {VERSION} release audit passed: release identity, reported Razor/DevExpress compiler repairs and XML warning cleanup, "
