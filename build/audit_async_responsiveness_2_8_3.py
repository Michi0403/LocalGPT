...
require('src/LocalGPT/LocalGPT.csproj','<Version>3.0.7</Version>')
require('src/LocalGPTWebviewWrapper/LocalGPTWebviewWrapper.csproj','<Version>3.0.7</Version>')
require('src/LocalGPTInstallerConsole/LocalGPTInstallerConsole.csproj','<Version>3.0.7</Version>')
