...
require('src/LocalGPT/LocalGPT.csproj','<Version>2.8.4</Version>')
require('src/LocalGPTWebviewWrapper/LocalGPTWebviewWrapper.csproj','<Version>2.8.4</Version>')
require('src/LocalGPTInstallerConsole/LocalGPTInstallerConsole.csproj','<Version>2.8.4</Version>')
