...
for rel in (
    ...
    require(rel, "<Version>3.5.3</Version>")
major, minor, patch = (3, 5, 2)
if minor > 9 or patch > 9:
    errors.append("release version violates the one-digit minor/patch slot policy")
require("RELEASE.md", "CHANGELOG-v3.5.3-WINDOWS-NATIVE-PACKAGING-FILE-HANDLE-REPAIR.md")
require("RELEASE.md", "VALIDATION-v3.5.3-source.md")
text("CHANGELOG-v3.5.3-WINDOWS-NATIVE-PACKAGING-FILE-HANDLE-REPAIR.md")
text("VALIDATION-v3.5.3-source.md")
require("docs/docfx.json", '"localgptVersion": "3.5.3"')
require("docs/pdf/toc.yml", "LocalGPT-3.5.3.pdf")
require("src/LocalGPT/Components/App.razor", "localgpt-chat-ui.js?v=3.5.3")
require("src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs", "LocalGPT/3.5.3")
...
if errors:
    print("LocalGPT 3.5.3 static release audit FAILED:")
    for error in errors:
        print(" -", error)
    raise SystemExit(1)
print("LocalGPT 3.5.3 static release audit passed.")
