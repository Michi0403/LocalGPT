...
def main() -> int:
    ...
    require("CHANGELOG-v4.7.2-COUNCIL-ARENA-REPAIR.md", f"# LocalGPT {VERSION}")
    require("VALIDATION-v4.7.2-source.md", f"# LocalGPT {VERSION} source validation")
    require("src/LocalGPT/Components/App.razor", "localgpt-game-console.js?v=4.7.2", "localgpt-chat-ui.js?v=4.7.2")
    require("src/LocalGPT/Services/InitialSetupAssistantService.cs", "LocalGPT/4.7.2")
    require("src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs", "LocalGPT/4.7.2")
    require("docs/index.md", "**Version 4.7.2**", "LocalGPT-4.7.2.pdf")
    require("docs/docfx.json", '"localgptVersion": "4.7.2"')
    require("docs/pdf/toc.yml", "LocalGPT-4.7.2.pdf")
    require("docs/pdf-cover.html", "LocalGPT 4.7.2 Documentation", "Version 4.7.2")
    ...
    print(f"LocalGPT {VERSION} release audit passed: Council binding/startup, responsive ASCII/Pixel popup, active-pair tournament scheduling, bounded context and animated generated arena presentation are wired without dropping protected prior surfaces.")
    return 0
