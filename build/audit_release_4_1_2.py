...
for relative in (
    ...
    version(relative, "4.1.2")

for relative, token in (
    ("docs/docfx.json", '"localgptVersion": "4.1.2"'),
    ("docs/pdf/toc.yml", "LocalGPT-4.1.2.pdf"),
    ("docs/pdf-cover.html", "LocalGPT 4.1.2 Documentation"),
    ("docs/index.md", "**Version 4.1.2**"),
    ("src/LocalGPT/Components/App.razor", "localgpt-chat-ui.js?v=4.1.2"),
    ("src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs", "LocalGPT/4.1.2"),
    ("src/LocalGPT/Services/InitialSetupAssistantService.cs", "LocalGPT/4.1.2"),
    ("docs/reference/ai-provider-installation.md", "LocalGPT/4.1.2"),
...
if failures:
    print("LocalGPT 4.1.2 release audit FAILED:")
    print("\n".join(f" - {failure}" for failure in failures))
    sys.exit(1)
print("LocalGPT 4.1.2 release audit passed: adaptive low-memory DocFX/PDF policy is guarded while 4.1.1 provider management, 4.1.0 Matrix operator controls, renderer affinity and earlier macOS signing/PDF protections remain intact.")
