...
def main() -> int:
    ...
    require("CHANGELOG-v4.7.5-BENCHMARK-JSON-AND-FILE-LOG-RESILIENCE.md", f"# LocalGPT {VERSION}")
    require("VALIDATION-v4.7.5-source.md", f"# LocalGPT {VERSION} source validation")
    require("src/LocalGPT/Components/App.razor", "localgpt-game-console.js?v=4.7.5", "localgpt-chat-ui.js?v=4.7.5")
    require("src/LocalGPT/Services/InitialSetupAssistantService.cs", "LocalGPT/4.7.5")
    require("src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs", "LocalGPT/4.7.5")
    require("docs/index.md", "**Version 4.7.5**", "LocalGPT-4.7.5.pdf")
    require("docs/docfx.json", '"localgptVersion": "4.7.5"')
    require("docs/pdf/toc.yml", "LocalGPT-4.7.5.pdf")
    require("docs/pdf-cover.html", "LocalGPT 4.7.5 Documentation", "Version 4.7.5")
    ...
    print(f"LocalGPT {VERSION} release audit passed: benchmark JSON scanning avoids exception-driven brace probing, file logging uses one resilient shared sink, Ollama cancellation remains contained, and prior Council, tournament, ASCII popup and InteractiveServer contracts remain present.")
    return 0
