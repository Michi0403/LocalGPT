...
def main():
    ...
    req('CHANGELOG-v4.6.7-CHAT-RENDER-REPAIR.md', f'# LocalGPT {VERSION}')
    req('VALIDATION-v4.6.7-source.md', f'# LocalGPT {VERSION} source validation')
    req('src/LocalGPT/Components/App.razor', 'localgpt-game-console.js?v=4.6.7')
    req('src/LocalGPT/Components/App.razor', 'localgpt-chat-ui.js?v=4.6.7')
    req('src/LocalGPT/Services/InitialSetupAssistantService.cs', 'LocalGPT/4.6.7')
    req('src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs', 'LocalGPT/4.6.7')
    req('docs/index.md', '**Version 4.6.7**')
    req('docs/docfx.json', '"localgptVersion": "4.6.7"')
    req('docs/pdf-cover.html', 'LocalGPT 4.6.7 Documentation')
    req('docs/pdf/toc.yml', 'LocalGPT-4.6.7.pdf')
    ...
    print(f'LocalGPT {VERSION} release audit passed: the Chat DxGridLayoutItem runtime regression is repaired and guarded; prior compile/architecture repairs, upload/recommendation UX, invariant SpinEdit, operation activity, quarantine/review boundaries, InteractiveServer topology and {checked} JS hashes are consistent.')
    return 0
