...
def main() -> int:
    ...
    require("CHANGELOG-v4.7.6-LOCAL-AI-RUNTIME-PYTHON-HUGGINGFACE.md", f"# LocalGPT {VERSION}")
    require("VALIDATION-v4.7.6-source.md", f"# LocalGPT {VERSION} source validation")
    require("src/LocalGPT/Components/App.razor", "localgpt-game-console.js?v=4.7.6", "localgpt-chat-ui.js?v=4.7.6")
    require("src/LocalGPT/Services/InitialSetupAssistantService.cs", "LocalGPT/4.7.6")
    require("src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs", "LocalGPT/4.7.6")
    require("docs/index.md", "**Version 4.7.6**", "LocalGPT-4.7.6.pdf")
    require("docs/docfx.json", '"localgptVersion": "4.7.6"')
    require("docs/pdf/toc.yml", "LocalGPT-4.7.6.pdf")
    require("docs/pdf-cover.html", "LocalGPT 4.7.6 Documentation", "Version 4.7.6")
    ...
    print(f"LocalGPT {VERSION} release audit passed: Local AI runtime/Hugging Face/Python.NET contracts are present, persistent model caching and bounded media admission are guarded, and prior benchmark, Council, ASCII and InteractiveServer contracts remain present.")
    return 0
