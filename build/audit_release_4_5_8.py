...
def main() -> int:
    ...
    req("RELEASE.md", "# LocalGPT 4.5.8")
    req("VALIDATION.md", "# LocalGPT 4.5.8 source validation")
    req("CHANGELOG-v4.5.8-TEXT-SERVICE-RAZOR-COMPILE-REPAIR.md", "# LocalGPT 4.5.8")
    req("VALIDATION-v4.5.8-source.md", "# LocalGPT 4.5.8 source validation")
    req("src/LocalGPT/Components/App.razor", "localgpt-game-console.js?v=4.5.8")
    req("src/LocalGPT/Components/App.razor", "localgpt-chat-ui.js?v=4.5.8")
    req("src/LocalGPT/Services/InitialSetupAssistantService.cs", "LocalGPT/4.5.8")
    req("src/LocalGPT/Services/CanIRunHardwareRecommendationService.cs", "LocalGPT/4.5.8")
    req("docs/pdf-cover.html", "LocalGPT 4.5.8 Documentation")
    req("docs/index.md", "**Version 4.5.8**")
    req("docs/pdf/toc.yml", "LocalGPT-4.5.8.pdf")
    req("docs/docfx.json", "LocalGPT 4.5.8 · generated documentation")
    req("docs/docfx.json", '"localgptVersion": "4.5.8"')
    req("docs/reference/ai-provider-installation.md", "LocalGPT/4.5.8")
    ...
    # 4.5.7 selector/range-editor repair retained; 4.5.8 adds compile-followup assertions.
    ...
    req("src/LocalGPT/Components/Pages/Chat.razor", 'ValueChanged="@((string selectedName) => OnProviderSelectionChanged(selectedName))"')
    forbid("src/LocalGPT/Components/Pages/Chat.razor", 'ValueChanged="OnProviderSelectionChanged"')
    req("src/LocalGPT/Components/Shared/ChatGameConsole.razor", "AsciiText.BuildConsoleLayoutSignature(")
    forbid("src/LocalGPT/Components/Shared/ChatGameConsole.razor", "var layoutSignature = string.Join(")
    req("src/LocalGPT/Services/AsciiChatTextService.cs", "public string BuildConsoleLayoutSignature(")
